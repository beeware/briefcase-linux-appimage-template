...
3. `Download the Python Linux support package for x86_64`_, and extract it into
   ...
   ``My Project.AppDir/usr/lib/python3.7`` directory, as well as some other
...
.. _Download the Python Linux support package for x86_64: https://briefcase-support.s3-us-west-2.amazonaws.com/python/3.7/linux/Python-3.7-linux-x86_64-support.b1.tar.gz
