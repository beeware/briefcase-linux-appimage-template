...
3. `Download the Python Linux support package for x86_64`_, and extract it into
   ...
   Project.AppDir/usr/lib/python3.6`` directory, as well as some other
...
.. _Download the Python Linux support package for x86_64: https://briefcase-support.org/python?platform=linux&arch=x86_64&version=3.6
